    ...
    <Card variant="raised" class="card-style">
        <Content class="mdc-typography--body2 card-content">
            <div class="content-header">
                <img src="/images/earth_icon.svg" alt="air" class="air-icon">
                <h2 class="mdc-typography--subtitle1">Amianto nel Suolo</h2>
            </div>
            <p class="text">
                ...possono contaminare il suolo rovinando i nostri paesaggi...
            </p>
        </Content>
        <Actions>
